...
Project and ranking data is stored locally as JSON/CSV under `tracking_data/`
(configurable via `OPEN_SEO_DATA_DIR`). This directory is gitignored — it
holds client keyword data, not code.
...
open_seo/
  ...
  storage.py          # JSON/CSV persistence for projects and rankings
```
